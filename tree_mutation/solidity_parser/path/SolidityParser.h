...
public:
  ...
  enum {
    ...
    RuleIfStatement = 41, RuleTryStatement = 42, RuleCatchClause = 43, RuleWhileStatement = 44, 
    RuleSimpleStatement = 45, RuleForStatement = 46, RuleInlineAssemblyStatement = 47, 
    RuleDoWhileStatement = 48, RuleContinueStatement = 49, RuleBreakStatement = 50, 
    RuleReturnStatement = 51, RuleThrowStatement = 52, RuleEmitStatement = 53, 
    RuleVariableDeclarationStatement = 54, RuleVariableDeclarationList = 55, 
    RuleIdentifierList = 56, RuleElementaryTypeName = 57, RuleExpression = 58, 
    RulePrimaryExpression = 59, RuleExpressionList = 60, RuleNameValueList = 61, 
    RuleNameValue = 62, RuleFunctionCallArguments = 63, RuleFunctionCall = 64, 
    RuleAssemblyBlock = 65, RuleAssemblyItem = 66, RuleAssemblyExpression = 67, 
    RuleAssemblyCall = 68, RuleAssemblyLocalDefinition = 69, RuleAssemblyAssignment = 70, 
    RuleAssemblyIdentifierOrList = 71, RuleAssemblyIdentifierList = 72, 
    RuleAssemblyStackAssignment = 73, RuleLabelDefinition = 74, RuleAssemblySwitch = 75, 
    RuleAssemblyCase = 76, RuleAssemblyFunctionDefinition = 77, RuleAssemblyFunctionReturns = 78, 
    RuleAssemblyFor = 79, RuleAssemblyIf = 80, RuleAssemblyLiteral = 81, 
    RuleSubAssembly = 82, RuleTupleExpression = 83, RuleTypeNameExpression = 84, 
    RuleNumberLiteral = 85, RuleIdentifier = 86
  };
